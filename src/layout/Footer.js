  ...
  <Link href="/">
    <a>
      ...
      />
        ...
        <div className="col-lg-4 col-md-6 order-md-1">
          <div className="footer-widget menu-widget two-column">
            <h4 style={{marginTop:4}} className="footer-title" >Quick Links</h4>
            <ul>
              <li>
                <Link href="/about">
                  <a>About Us</a>
        ...
        <div className="col-lg-4 col-md-6 order-md-3">
          <div className="footer-widget contact-widget">
            <h4 style={{marginTop:4}} className="footer-title">Contact Us</h4>
           
            <ul>
              <li>
                <i className="fal fa-map-marker-alt" />
                Ferozepur Road,opp Baba Jahar Bali, Baddowal, Ludhiana - 141021.
              </li>
              <li>
                <i className="far fa-envelope" />
                <a href="calto:+91 81478-00001">+91 81478-00001</a>
              </li>
              <li>
      ...
      <div className="copyright-area pt-25 pb-10">
        <p>Copyright © 2024 JVCOrganic. All Rights Reserved.</p>
...
const Footer3 = () => (
  <footer className="main-footer footer-black text-white">
          ...
          <div className="row justify-content-between">
            <div className="col-lg-4 col-sm-6">
              <div className="footer-widget news-widget">
                <h4 style={{marginTop:4}} className="footer-title">Recent News</h4>
                <ul>
                  <li>
                    <div className="image">
                      <img
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="footer-widget gallery-widget">
                <h4 style={{marginTop:4}} className="footer-title">Gallery</h4>
                <ul>
                  <li>
    ...
    <div className="copyright-area-wrap">
      <div className="container-fluid">
        <div className="copyright-area pt-25 pb-10">
          <p>Copyright © 2022 JVC Organic. All Rights Reserved.</p>
          <ul className="footer-menu">
            <li>
              <Link href="/contact">
                <a>Setting &amp; Privacy</a>
