          ...
          <div className="row show-grid-row">
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="product-item wow fadeInUp delay-0-6s">
                ...
                <div className="content">
                  ...
                  <h5>
                    <Link href="/product-details">pea</Link>
                  </h5>
                  <span className="price">
                    <del>25</del>
                    <span>18</span>
            ...
            <div className="col-xl-3 col-lg-4 col-sm-6">
              <div className="product-item wow fadeInUp delay-0-2s">
                ...
                <div className="image">
                  <img
                    src="https://img.freepik.com/free-photo/red-onion-whole-isolated-white_146671-19175.jpg?size=626&ext=jpg&ga=GA1.1.1119669359.1702983739&semt=sph"
                    alt="Product"
                  />
                </div>
                <div className="content">
                  ...
                  <h5>
                    <Link href="/product-details">Onion</Link>
                  </h5>
                  <span className="price">
                    <del>55</del>
                    <span>36</span>
